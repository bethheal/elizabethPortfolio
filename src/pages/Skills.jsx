...
// Dev Tools Icons
import { FaReact, FaNodeJs, FaCss3Alt, FaJsSquare, FaGitAlt } from "react-icons/fa";
import { SiTailwindcss, SiMongodb, SiExpress, SiFigma, SiMiro, SiTrello, SiClickup, SiNetlify } from "react-icons/si";

const devSkills = [
  { name: "React.js", icon: <FaReact className="text-sky-400" />, level: 85 },
  { name: "TailwindCSS", icon: <SiTailwindcss className="text-cyan-400" />, level: 90 },
  { name: "JavaScript", icon: <FaJsSquare className="text-yellow-400" />, level: 75 },
  { name: "Node.js", icon: <FaNodeJs className="text-green-500" />, level: 50 },
  { name: "MongoDB", icon: <SiMongodb className="text-green-400" />, level: 45 },
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="relative z-10 bg-black text-white min-h-screen py-10 mt-10  mb-10 px-6 ">
      {/* Heading */}
      ...
      {/* Development Skills */}
      <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
